...
public class AdministradorMain extends javax.swing.JFrame {
    ...
    String roldata1, roldata2;
    GestionEncabezadoTabla gg;
    JScrollPane scroll;
    JPanel contentpane;
    ...
    public AdministradorMain() {
        initComponents();
        TextPrompt busqueda = new TextPrompt("Ingrese el dato", jTextField1);
    ...
    private void initComponents() {
        ...
        visor.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jMenuBar1.setPreferredSize(new java.awt.Dimension(171, 35));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 1036, Short.MAX_VALUE))
        );
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        RegistroclienteAdm rca = new RegistroclienteAdm();
        rca.setVisible(true);
        this.setVisible(false);
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        ...
        ntabla = "empleados";
        jComboBox1.removeAllItems();
        jComboBox1.addItem("id_empleado");
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        if (jTextField1.getText().trim() != "") {
            ...
            JOptionPane.showMessageDialog(null, "Confirmacion", "Busqueda compleatada", JOptionPane.INFORMATION_MESSAGE);
        } else {
            System.out.println("Error");
        }
